...
CONSTRAINT FK_ID_Especialidades 
	FOREIGN KEY (ID_Especialidades) REFERENCES Laborflex.Especialidades(ID_Especialidades)
...
CONSTRAINT FK_ID_Dentistas
	FOREIGN KEY (ID_Dentistas) REFERENCES Laborflex.Dentistas(ID_Dentistas)
);
...
CONSTRAINT FK_Dentistas_Pacientes
	FOREIGN KEY (ID_Dentistas) REFERENCES Laborflex.Dentistas(ID_Dentistas)
);
...
UPDATE Pacientes
SET Sobrenome = 'Sângelo'
WHERE ID_Pacientes = '1' ;
    
UPDATE Pacientes
SET Sobrenome = 'Passos'
...
CONSTRAINT FK_ID_Trabalho 
	FOREIGN KEY (ID_Trabalhos) REFERENCES Laborflex.Trabalhos(ID_Trabalhos)
);
...
CONSTRAINT FK_ID_Itens_Pedido
	FOREIGN KEY (ID_Itens_Pedido) REFERENCES Laborflex.Itens_Pedido(ID_Itens_Pedido),
CONSTRAINT FK_ID_Paciente
	FOREIGN KEY (ID_Pacientes) REFERENCES Laborflex.Pacientes(ID_Pacientes)
);
...
CONSTRAINT FK_ID_Dentistas_Nota
	FOREIGN KEY (ID_Dentistas) REFERENCES Laborflex.Dentistas(ID_Dentistas)
);
...
CONSTRAINT FK_ID_Nota_Fiscal
	FOREIGN KEY (ID_Nota_Fiscal) REFERENCES Laborflex.Nota_Fiscal(ID_Nota_Fiscal),
CONSTRAINT FK_ID_Pedido
	FOREIGN KEY (ID_Pedido) REFERENCES Laborflex.Pedido(ID_Pedido)
);
...
ON i.ID_Trabalhos = t.ID_Trabalhos 
